/**
 * PHASE ID-3A: تحقق توقيع بيانات اعتماد تفعيل المعلم — ECDSA P-256/SHA-256
...
/** يتحقق من التوقيع فقط (بلا فحص بنية/شكل payload — تلك مسؤولية الطبقة الأعلى في teacherActivation.ts). */
