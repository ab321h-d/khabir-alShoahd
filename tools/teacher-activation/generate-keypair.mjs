 ...
 * اعتماد تفعيل المعلم. لا تُشغَّل أبدًا كجزء من build العميل، ولا تُستورَد
 ...
 *     tools/teacher-activation/.local-keys/private-key.local.json
...
async function main() {
  ...
  console.log("انسخ محتوى public-key.local.json يدويًا إلى TEACHER_ACTIVATION_PUBLIC_KEY_JWK في:");
  console.log("  client/src/lib/teacherActivationConfig.ts");
  console.log();
