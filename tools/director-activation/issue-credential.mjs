 ...
 *
 * الاستخدام:
 *   node tools/director-activation/issue-credential.mjs \
...
async function main() {
  ...
  console.log();
  console.log("=== بيانات الاعتماد (سلّمها للمدير) ===");
